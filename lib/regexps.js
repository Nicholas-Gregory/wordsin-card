...
export const timeModifier =`( for (?<timeModifier>the rest of the encounter|(?<timeModifierAmount>${amount}) more (?<timeModifierSpan>${getListRegExp('TIME')})(?<spanIncidental>s)?))`;
