...
export default class EffectText {
    ...
    replaceText(property, newText, indices) {
        if (this.parse.groups[property] === undefined && newText === '') return this;
        
        const [start, end] = this.getIndices(property) || indices;
