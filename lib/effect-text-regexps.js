...
// Focus
export const focusInstruction = `Add|Subtract|Gain|Lose`;
export const focusTargetClass = `character|ally|enemy|card`;
export const focusEffect = `(?<instruction>${focusInstruction}) (?<amount>${amount})( focus)? (for|to|from) (?<targetType>${targetType})('s focus cost)? (?<targetClass>${focusTargetClass})?(${timeModifier})?`;
