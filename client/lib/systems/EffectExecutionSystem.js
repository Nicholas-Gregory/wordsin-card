...
const effectExecutionSystemCallback = (effect, casterSystem, targetSystem) => {
    const target = targetSystem.getEntityById(effect.target);
    const caster = casterSystem.getEntityById(effect.caster);
...
export default class EffectExecutionSystem extends System {
    constructor(entities) {
        super(['target', 'caster'], null, entities, effectExecutionSystemCallback);
    }
}